...
## Z-score normalization is performed in the logisticRegression file, using standardScalar()

# Extracts 10+ features from x, y, and z accelerations from the inputted Dataframe
...
# Segments the dataframe int ~5-second windows. If there are at least 4 seconds of data remaining
# after the ~5-second windows,Then saves one last window (between 3.75 and 4.75 seconds long)
